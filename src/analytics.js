...
// Default consent reads localStorage("db-analytics") — granted unless the user
// has explicitly opted out. No cookie banner; opt-out lives in the UI.
export function initAnalytics() {
  ...
  try {
    if (localStorage.getItem("db-analytics") === "denied") savedConsent = "denied";
  } catch { /* ignore */ }
